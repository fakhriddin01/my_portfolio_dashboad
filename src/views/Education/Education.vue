...
import { useEducation } from '../../service/education';
...
const addContact=(evet)=>{
    ...
    useEducation.create(contact).then((res)=>{
        if(res.status == 201){
...
const modifyContact=(event)=>{
    ...
    useEducation.update(id, contact).then((res)=>{
        if(res.status == 200){
...
const removeContact=()=>{
    ...
    console.log(id);
    useEducation.remove(id).then((res)=>{
        if(res.status == 200){
...
const updateContact = (id)=>{
    ...
    contactInfo.start = foundContact[0].start
    contactInfo.end = foundContact[0].end
    contactInfo.organization = foundContact[0].organization
    contactInfo.major = foundContact[0].major
    toggleModal();
}
...
<template>
  ...
  <div class="p-3">
    <h2 class="uppercase dark:text-white text-gray-900 font-bold">Education</h2>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        <span v-if="!isUpdate">Add new education</span>
                        <span v-else>Update education</span>
                    </h3>
                ...
                <form >
                    <div class="grid gap-4 mb-4 sm:grid-cols-1">
                        ...
                        <div>
                            ...
                            <input v-model="contactInfo.start" type="date" name="link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                        </div>
                        <div>
                            <label for="start" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">End</label>
                            <input v-model="contactInfo.end" type="date" name="link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                        </div>
                        <div>
                            <label for="icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Organization</label>
                            <input v-model="contactInfo.organization" type="text" name="icon"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                        </div>
                        <div>
                            <label for="icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Major</label>
                            <input v-model="contactInfo.major" type="text" name="icon"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                        </div>
                ...
                <table class="w-full text-sm table-auto">
                    ...
                    <tbody class="">
                        <tr v-for="(el, index) in computedList" :key="el.id" class="border-b dark:border-gray-700">
                            <td class="px-4 py-3">{{ el.organization}}</td>
                            <td class="px-4 py-3">{{ el.major}}</td>
